...
class Initial_info
{
    ...
    public function read_single()
    {
        $query = 'SELECT * FROM ' . $this->table . ' WHERE academic_year_from = :academic_year_from AND'
            . ' academic_year_to = :academic_year_to AND dept_id = :dept_id AND semester = :semester';
    ...
    {
        $query = 'SELECT * FROM ' . $this->table . ' WHERE timetable_id = :timetable_id';
    ...
    public function post()
    {
        ...
        . ' academic_year_to = :academic_year_to, dept_id = :dept_id, semester = :semester';
    ...
    public function delete_row()
    {
        ...
        $stmt->bindParam(':timetable_id', $this->id);
